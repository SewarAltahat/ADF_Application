...
// ---    Thu Aug 03 19:32:08 GMT+03:00 2023
// ---    Custom code may be added to this class.
// ---    Warning: Do not modify method signatures of generated methods.
// ---------------------------------------------------------------------
public class ArcFilesLocationTlImpl
  extends AuditEntityImpl
{
  ...
  {
    return EntityDefImpl.findDefObject("arc.model.eo.ArcFilesLocationTl");
  }
  ...
  {
    return (ArcFilesLocationImpl) getAttributeInternal(ARCFILESLOCATION);
  }

  /**
   * Sets <code>value</code> as the associated entity ArcFilesLocationImpl.
   */
  public void setArcFilesLocation(ArcFilesLocationImpl value)
  {
    setAttributeInternal(ARCFILESLOCATION, value);
  }
  ...
  protected void doDML(int operation, oracle.jbo.server.TransactionEvent e)
  {
    ...
    {
      BigDecimal pk = gen.common.GenLib.getPrimaryKeyValue(getDBTransaction(), "ARC_FILES_LOCATION_TL_SEQ");
